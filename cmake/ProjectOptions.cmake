...
macro(setup_options)
  ...
  if(NOT PROJECT_IS_TOP_LEVEL OR PACKAGING_MAINTAINER_MODE)
    ...
    option(ENABLE_USER_LINKER "Enable user-selected linker" ON)
...
macro(global_options)
  ...
  if(ENABLE_HARDENING AND ENABLE_GLOBAL_HARDENING)
    ...
    message(STATUS "Hardening: ${ENABLE_HARDENING} ${ENABLE_UBSAN_MINIMAL_RUNTIME} ${ENABLE_SANITIZER_UNDEFINED}")
